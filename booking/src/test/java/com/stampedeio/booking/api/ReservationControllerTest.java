...
class ReservationControllerTest {
    ...
    @Nested
    @DisplayName("PATCH /api/v1/reservations/{id}/confirm")
    class ConfirmEndpointTests {

        @Test
        @DisplayName("AC2: confirm HELD reservation returns 200 with CONFIRMED status")
        ...
        void confirm_alreadyConfirmed_returns409() throws Exception {
            ...
            mvc.perform(patch("/api/v1/reservations/{id}/confirm", reservationId)
                    ...
                    .andExpect(jsonPath("$.detail").value(
                            "Cannot transition reservation from CONFIRMED to CONFIRMED"));
        }
        ...
        void confirm_expired_returns409() throws Exception {
            ...
            mvc.perform(patch("/api/v1/reservations/{id}/confirm", reservationId)
                    ...
                    .andExpect(content().contentType(MediaType.APPLICATION_PROBLEM_JSON))
                    .andExpect(jsonPath("$.detail").value(
                            "Cannot transition reservation from EXPIRED to CONFIRMED"));
        }
    ...
    @Nested
    @DisplayName("PATCH /api/v1/reservations/{id}/release")
    class ReleaseEndpointTests {

        @Test
        @DisplayName("AC3: release HELD reservation returns 200 with RELEASED status")
        ...
        void release_alreadyReleased_returns409() throws Exception {
            ...
            mvc.perform(patch("/api/v1/reservations/{id}/release", reservationId))
                    ...
                    .andExpect(jsonPath("$.status").value(409))
                    .andExpect(jsonPath("$.detail").value(
                            "Cannot transition reservation from RELEASED to RELEASED"));
        }
